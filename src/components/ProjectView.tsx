...
const ProjectView: React.FC<ProjectViewProps> = ({
  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-1 hover:shadow-lg">
      <img src={image} alt="" loading="lazy" />
      <div className="dark:bg-dark-card p-4">
        <h1 className="dark:text-light-heading font-semibold text-lg pt-1">{title}</h1>
        <p className="text-content pt-4 font-light h-24 overflow-hidden">{description}</p>
